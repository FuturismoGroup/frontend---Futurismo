    ...
    try {
      ...
      if (reportType === 'monthly') {
        ...
        if (reportData.dailyData && reportData.dailyData.length > 0) {
          const dailyHeaders = [['Fecha', 'Reservaciones', 'Participantes']];
        ...
        if (reportData.serviceBreakdown && Object.keys(reportData.serviceBreakdown).length > 0) {
          const serviceHeaders = [['Servicio', 'Cantidad', 'Participantes']];
        ...
        // === REPORTE ANUAL ===
        const yearlyHeaders = [['Mes', 'Reservaciones', 'Participantes']];
        ...
        const yearlyData = [
          ...
          ...yearlyRows,
          [],
          ['TOTALES', totalReservations, totalParticipants]
        ];
