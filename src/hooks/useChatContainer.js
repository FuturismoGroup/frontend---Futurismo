    ...
    const createOrFindConversation = async () => {
      ...
      try {
        ...
        const guideChat = {
          ...
          lastMessage: conversation.last_message?.content || i18next.t('chat.startConversation', { defaultValue: 'Inicia la conversación' }),
        ...
        const guideChat = {
          ...
          name: decodeURIComponent(guideName),
          avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(guideName)}&background=3B82F6&color=fff`,
          lastMessage: i18next.t('chat.startConversation', { defaultValue: 'Inicia la conversación' }),
