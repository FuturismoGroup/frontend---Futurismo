      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3 flex-1">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-gray-900">{t('profile.comp.professionalData')}</h3>
            <p className="text-sm text-gray-500">{t('profile.comp.professionalDataSubtitle')}</p>
          </div>
          <button
